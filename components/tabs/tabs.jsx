...
export default class Tabs extends React.Component {
  ...
  render() {
    ...
    return (
      <RcTabs {...this.props} className={cls} tabBarPosiotn={tabPosition}
        renderTabBar={renderTabBar} renderTabContent={() => <TabContent animated={tabPaneAnimated} animatedWithMargin />}
